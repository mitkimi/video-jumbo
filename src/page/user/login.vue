    ...
    <transition name="form-fade" mode="in-out">
      <div class="login-form" v-show="showLogin">
        <div class="login-logo">
          <img src="../../images/logo.png"> <span>ipietech.com</span>
        </div>
        <el-form :model="formLogin" :rules="rulesLogin" ref="formLogin">
          <el-form-item prop="username">
            <el-input type="text" v-model="formLogin.username" auto-complete="off" @keyup.enter.native="submitForm('formLogin')" clearable></el-input>
          </el-form-item>
          <el-form-item prop="password">
            <el-input type="password" v-model="formLogin.password" auto-complete="off" @keyup.enter.native="submitForm('formLogin')" clearable></el-input>
          </el-form-item>
          <el-form-item>
